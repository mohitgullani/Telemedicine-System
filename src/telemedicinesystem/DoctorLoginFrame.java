...
public class DoctorLoginFrame extends javax.swing.JFrame {
    ...
    public DoctorLoginFrame(String status) {
        initComponents(); 
...
Connection con;
    ...
    private void l3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_l3MouseClicked
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("Select count(*) from Doctor where Username='"+username+"' and Password='"+password+"' and Account_Status='Activated'");
            while(rs.next())
            {
